...
namespace PrintPreview_PrintList
{
    public partial class Form1 : Form
    {
        ...
        private void printDocument1_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawLine(new Pen(Color.Blue, 2), pageSettings.Margins.Left, y, pageSettings.PaperSize.Width - pageSettings.Margins.Right, y);
            ...
            e.Graphics.DrawString("Result", headerFont, new SolidBrush(Color.Red), x + 2 * pageWidth / 3, y);
            y += rowHeight + 2;
            e.Graphics.DrawLine(new Pen(Color.Blue, 2), pageSettings.Margins.Left, y, pageSettings.PaperSize.Width - pageSettings.Margins.Right, y);
            ...
            while (elementNo < listBox1.Items.Count)
            {
                ...
                e.Graphics.DrawString(listBox2.Items[elementNo].ToString(), listFont, new SolidBrush(Color.Red), x + pageWidth / 3 + 50, y, alignRight);
                e.Graphics.DrawString(listBox3.Items[elementNo].ToString(), listFont, new SolidBrush(Color.Red), x + 2 * pageWidth / 3, y);
                y += rowHeight + 2;
                e.Graphics.DrawLine(new Pen(Color.Blue, 2), pageSettings.Margins.Left, y, pageSettings.PaperSize.Width - pageSettings.Margins.Right, y);
                elementNo += 1;
